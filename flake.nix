{
  ...
  inputs = {
    ...
    kernel-cachyos.url = "github:ShaoG-R/nixos-config?dir=extra/kernel/cachyos";
    kernel-cachyos.inputs.nixpkgs.follows = "nixpkgs";
    
    kernel-cachyos-unstable.url = "github:ShaoG-R/nixos-config?dir=extra/kernel/cachyos-unstable";
